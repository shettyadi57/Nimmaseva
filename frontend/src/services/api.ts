...
const MOCK_SCHEMES: Scheme[] = [
  {
    ...
    district: 'Shivamogga',
    description: 'Financial assistance of ₹2,000 per month for female head of the family.',
    required_documents: ['Aadhaar Card', 'BPL Card', 'Aadhaar-seeded Bank Passbook'],
  ...
  },
  {
    ...
    district: 'Shivamogga',
    description: 'Unemployment stipend of ₹3,000/month for graduates and ₹1,500/month for diploma holders.',
    required_documents: ['Degree/Diploma Certificate', 'Aadhaar Card', 'Bank Passbook'],
    benefits: 'Up to ₹3,000 / month for 2 years',
    apply_link: 'https://sevasindhugs.karnataka.gov.in'
  },
  {
    id: 3,
    ...
    district: 'Shivamogga',
    description: 'Scholarship for children of farmers studying post-matric and higher education.',
    required_documents: ['Farmer FID Number', 'Student Aadhaar', 'College Admission Receipt'],
    benefits: '₹2,500 to ₹11,000 per year',
  ...
  },
  {
    ...
    district: 'Shivamogga',
    description: 'Monthly old-age pension for senior citizens aged 65 and above in Karnataka.',
    required_documents: ['Age Proof Certificate', 'Income Certificate', 'Bank Passbook'],
    benefits: '₹1,200 / month pension',
